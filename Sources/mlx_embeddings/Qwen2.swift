...
public class Qwen2Model: Module, EmbeddingModel, KVCacheDimensionProvider {
  ...
  {
    var out = model(inputIds, cache: nil)
  ...
  public func sanitize(weights: [String: MLXArray]) -> [String: MLXArray] {
    // Remove unused precomputed rotary freqs and lm_head weights
    return weights.filter {
      !$0.key.contains("self_attn.rotary_emb.inv_freq") && !$0.key.contains("lm_head")
    }
  }
}
