// Copied from https://github.com/ml-explore/mlx-swift-examples/blob/main/Libraries/Embedders/EmbeddingModel.swift
...
public actor ModelContainer {
  ...
  public init(
    model: EmbeddingModel, tokenizer: Tokenizer
  ) {
    self.model = model
  ...
  public func perform<R>(_ action: @Sendable (EmbeddingModel, Tokenizer) throws -> R)
    rethrows
    -> R
  {
